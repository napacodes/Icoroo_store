...
return [
	...
	"fields" => [
      ...
      "value" => "/assets/images/payment/razorpay_icon.png",
    ],
    "description" => [
			"type" => "hidden", 
			"validation" => "nullable|string", 
			"value" => "Debit or Credit Card, Netbanking, Bank Transfer, EMI, UPI",
		],
		"order" => [
			"type" => "hidden", 
		...
		"client_id" => [
			"type" => "string", 
			"validation" => "nullable|string|max:255|required_with:gateways.razorpay.enabled", 
			"value" => null
		],
		"secret_id" => [
			"type" => "string", 
