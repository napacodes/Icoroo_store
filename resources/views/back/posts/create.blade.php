...
@section('content')
<form class="ui large form" method="post" action="{{ route('posts.store') }}" enctype="multipart/form-data">
	@csrf
	...
	<div class="one column grid" id="post">
		<div class="column">
			...
			<div class="field">
				...
				<textarea name="content" class="html-editor" cols="30" rows="20">{{ old('content') }}</textarea>
			</div>
			<div class="field">
				<label>{{ __('Tags') }}</label>
