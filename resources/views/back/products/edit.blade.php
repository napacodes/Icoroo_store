			...
			<div class="column tabs">
				  ...
				  <div class="ui fluid card mt-1">
						...
						<div class="content d-block">
							<div class="field">
								...
								<input type="number" step="0.000000005" name="group_buy_price" value="{{ old('group_buy_price', $product->group_buy_price ?? null) }}">
							</div>
							<div class="field">
								<label>{{ __('Min buyers') }}</label>
								<input type="number" name="group_buy_min_buyers" value="{{ old('group_buy_min_buyers', $product->group_buy_min_buyers ?? null) }}">
							</div>
							<div class="field">
								<label>{{ __(' Expiry') }}</label>
								<input type="datetime-local" name="group_buy_expiry" value="{{ format_date(old('group_buy_expiry', $product->group_buy_expiry ?? null), 'Y-m-d\TH:i') }}">
							</div>
			  ...
			  <div class="ui tab segment" data-tab="seo">
					<div class="field">
						...
						<input type="text" name="meta_tags[title]" value="{{ old('meta_tags.title', $product->meta_tags->title ?? null) }}">
					</div>
					<div class="field">
						<label>{{ __('Description') }}</label>
						<input type="text" name="meta_tags[description]" value="{{ old('meta_tags.description', $product->meta_tags->description ?? null) }}">
					</div>
					<div class="field">
						<label>{{ __('Keywords') }}</label>
						<input type="text" name="meta_tags[keywords]" value="{{ old('meta_tags.keywords', $product->meta_tags->keywords ?? null) }}">
					</div>
			  </div>
