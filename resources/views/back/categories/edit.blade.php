...
<form class="ui large form" id="category" method="post" action="{{ route('categories.update', [$category->id, request()->for]) }}" enctype="multipart/form-data">
	@csrf
	...
	<div class="field">
		...
		<a class="ui icon labeled large circular button" href="{{ route('categories') }}">
	...
	<div class="field">
		...
		<div class="ui left action input">
		  <a class="ui teal labeled icon button" onclick="$('#icon-file').click()">
		    <i class="upload icon"></i>
		    {{ __('Browse') }}
		  </a>
		  <input type="file" name="icon" id="icon-file" class="d-none" accept="image/*">
		  <input type="text" name="icon" placeholder="{{ __('Enter a URL for an icon') }}" value="{{ $category->icon ? public_path("storage/icons/{$category->icon}") : null }}">
		</div>
	</div>
	...
	<div class="field">
		...
		<div class="ui selection floating dropdown">
			<input type="hidden" name="for" value="{{ old('for', $category->for ?? null) }}">
			<div class="text"></div>
			<div class="menu">
	...
	<div class="field">
		...
		<div class="ui selection floating dropdown parent-category">
			<input type="hidden" name="parent" value="{{ old('parent', $category->parent ?? null) }}">
			<div class="text"></div>
			<div class="menu"></div>
		</div>
	</div>
